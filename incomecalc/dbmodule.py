...
def showJanSumIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT SUM(sum) AS sum FROM income WHERE date like '" + current_year.__str__() + "-01-%';")
    res = cur.fetchone()

    return res

def showJanAvgIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT AVG(sum) AS avg FROM income WHERE date like '" + current_year.__str__() + "-01-%';")
    res = cur.fetchone()

    return res


def showFebSumIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT SUM(sum) AS sum FROM income WHERE date like '" + current_year.__str__() + "-02-%';")
    res = cur.fetchone()

    return res

def showFebAvgIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT AVG(sum) AS avg FROM income WHERE date like '" + current_year.__str__() + "-02-%';")
    res = cur.fetchone()
...
def showOctoberSumIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT SUM(sum) AS sum FROM income WHERE date like '" + current_year.__str__() + "-10-%';")
    res = cur.fetchone()

    return res

def showOctoberAvgIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT AVG(sum) AS avg FROM income WHERE date like '" + current_year.__str__() + "-10-%';")
    res = cur.fetchone()

    return res

def showNovemberSumIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT SUM(sum) AS sum FROM income WHERE date like '" + current_year.__str__() + "-11-%';")
    res = cur.fetchone()

    return res

def showNovemberAvgIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT AVG(sum) AS avg FROM income WHERE date like '" + current_year.__str__() + "-11-%';")
    res = cur.fetchone()

    return res

def showDecemberSumIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT SUM(sum) AS sum FROM income WHERE date like '" + current_year.__str__() + "-12-%';")
    res = cur.fetchone()

    return res

def showDecemberAvgIncomeTbl():
    today = datetime.date.today()
    current_year = today.year
    cur.execute("SELECT AVG(sum) AS avg FROM income WHERE date like '" + current_year.__str__() + "-12-%';")
    res = cur.fetchone()
