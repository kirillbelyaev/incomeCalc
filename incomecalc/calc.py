# Created on : May 19, 2024, 9:51:09 PM
# Author     : kirill
    ...
    def on_button_press(self, e):
        ...
        if label == "=":  # Calculate the result of the input in the TextCtrl
            ...
            try:
                ...
                wx.LogError(
                    "Invalid syntax ({}). Please check your input and try again.".format(
                        calculation
                    )
                )
                return
                ...
                NameError
            ) as err:  # Catch any manually typed errors (e.g. '2 x three')
                wx.LogError(
                    "There was a error. Please check your input and try again."
                )
                return
